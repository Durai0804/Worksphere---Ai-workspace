...
/**
 * Global exception handler — catches all exceptions thrown across all controllers.
 *
 * WHY: Centralizing error handling ensures the frontend always receives
 * a predictable JSON structure, even when things go wrong.
 */
@Slf4j
